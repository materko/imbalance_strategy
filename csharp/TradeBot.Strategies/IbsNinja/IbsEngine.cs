// `IbsEngine` - jeden vstupny bod strategie IBSNinja: spaja hodiny, detekciu zon a stavovy automat
...
using TradeBot.Core;
using TradeBot.Strategies.IbsNinja.Ta;

namespace TradeBot.Strategies.IbsNinja
{
    [TradeBotEngine("ibsninja", "IBSNinja Imbalance Breakout (C#)")]
