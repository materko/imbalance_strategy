// `OrbEngine` - strategia ORBNet (Opening Range Breakout) s jadrom v C#. Zrkadlo
...
namespace TradeBot.Strategies.OrbNet
{
    [TradeBotEngine("orbnet", "ORBNet Opening Range Breakout (C#)")]
