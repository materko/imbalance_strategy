# Šablóna MultiCharts študie pre Trendline Breakout (konsolidacia kdekolvek na grafe) — skopíruj obsah do
...
# z tradebot/strategies/trendlines/configs), alebo natvrdo nižšie cez PROFILE.
...
class Trendline:
    ...
    # trieda bez rodiča ako v šablóne bety; všetko deleguje na TrendlineSignal.
    def _sig(self):
        s = getattr(self, "_tb", None)
        if s is None:
            from tradebot.strategies.trendlines.multicharts import TrendlineSignal
