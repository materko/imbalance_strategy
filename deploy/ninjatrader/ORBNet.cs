// ORBNet - ORB (Opening Range Breakout) s jadrom v C# ako strategia NinjaTrader 8.
//
...
//
// Potom v NinjaTraderi: New > NinjaScript Editor > F5 (preklad), strategia „ORBNet" na MINUTOVOM grafe.
...
{
    public class ORBNet : TradeBotStrategy
    {
        protected override string EngineKey { get { return "orbnet"; } }
        ...
        protected override void OnStateChange()
        {
            ...
            if (State == State.SetDefaults)
            {
                ...
                // (`python -m tester.ninjatrader compare --strategy orbnet`). Pred optimalizaciou vypni.
                ExportSignals = true;
            }
        }
    }
