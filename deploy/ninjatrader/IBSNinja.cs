// IBSNinja - IBS Imbalance Breakout s jadrom v C# ako strategia NinjaTrader 8.
//
// Tento subor je len ukazovatel: cela logika je v C# jadre (`csharp/TradeBot.Strategies/IbsNinja`)
...
//
// Potom v NinjaTraderi: New > NinjaScript Editor > F5 (preklad), strategia „IBSNinja" na MINUTOVOM grafe.
...
{
    public class IBSNinja : TradeBotStrategy
    {
        protected override string EngineKey { get { return "ibsninja"; } }
