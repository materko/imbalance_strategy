...
Beh: `python -m tester.compare.scan_trades --exchange coinbase --profile btcusd_3m_coinbase`
...
spustiť nejde. `tester.compare.scan_trades` si 3m poskladá z 1m v pamäti (na disk sa nič
