...
Tester **oboma** enginmi), `data/quotemanager/` je z neho odvodený export pre MultiCharts —
bar razený zatvorením, objem celé číslo, CSV. Späť ho nikto nečíta, preto sa negituje
a vyrobí sa znova jedným príkazom.
