"""Report z Freqtrade backtestu vo vzhľade TradingView Strategy Testera.
    ...
    python -m tester.report                      # posledný backtest
    python -m tester.report vysledok.zip -o r.html
    python -m tester.report --list
...
from tradebot.core.paths import BACKTEST_RESULTS as RESULTS
