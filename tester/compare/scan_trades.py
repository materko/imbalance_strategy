"""Prejde reálne dáta celým stavovým automatom a vypíše obchody — smoke test kroku 3.
    ...
    python -m tester.compare.scan_trades --exchange binance --profile golden_binance_btcusdt_3m
    python -m tester.compare.scan_trades --csv C:/dukas/NAS100_M1_10Y.csv \\
