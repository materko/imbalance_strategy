...
#
#   ./webapp.sh                       # obal v koreni repozitára
#   ./tester/scripts/webapp.sh
#   TRADEBOT_WEB_PORT=9000 ./tester/scripts/webapp.sh
#   NO_BROWSER=1 ./tester/scripts/webapp.sh
#
# Viď docs/WEBAPP.md.
...
echo "TradeBot Tester: $URL  (Ctrl+C ukonci)"
