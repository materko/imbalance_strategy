...
from tradebot.adapters.multicharts import MCDrawSink, MCRunner, hex_to_rgb
from tradebot.core import Bar, DrawBox, DrawKind, DrawLabel, DrawLine, IBSConfig, LineStyle
from tradebot.core.drawing import DrawBg, DrawDelete, DrawUpdate
from tradebot.core.types import MNQ
...
def test_multicharts_a_freqtrade_daju_rovnake_zony():
    ...
    Ak sa toto rozíde, znamená to, že adaptér niekde obchádza `tradebot.core`.
    """
