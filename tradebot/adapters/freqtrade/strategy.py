"""Freqtrade adaptér — tenká vrstva nad `tradebot.core`.
...
Nastavenia stratégie sa berú z `tradebot/configs/ibs/*.json`, **nie** z Freqtrade configu.
Profil sa dá prepnúť cez `TRADEBOT_PROFILE` v prostredí.
"""
...
DEFAULT_PROFILE = getenv("PROFILE", "golden_binance_btcusdt_3m")
...
DRAW_OUT_ENV = "TRADEBOT_DRAW_OUT"
