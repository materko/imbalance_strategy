# Základná analytika — IBSNinja Imbalance Breakout (C# jadro) (`ibsninja`)
...
([meranie parity](../../../../docs/merania/PARITA_ibsninja_2026-09-20.md)). Verdikt o myšlienke je
...
prečo IBSNinja existuje, je NinjaTrader, a tam ešte nebežala ani raz.
...
na pláne, a nikto nezmeral, či to pomáha. **Špecifické pre IBSNinja** a dôležitejšie než všetky tri:
...
PY -m tester.webapp.cli run --strategy ibsninja --engine multicharts --pair NAS100/USD \
...
PY -m tester.webapp.cli sweep --strategy ibsninja --param minSlDistance=0.20:0.40:0.05@pct --goal break_even \
   --profile docs/profily_archiv/ibs/btcusdt_3m_binance_ny_sl_risk1.json --timerange 20240904-20250904
PY -m tester.webapp.cli sweep --strategy ibsninja --param useStructureFilter=true,false --goal break_even \
   --profile docs/profily_archiv/ibs/btcusdt_3m_binance_ny_sl_risk1.json --timerange 20240904-20250904
```
...
stopu, posun stopu na nulu po 1R kvôli sériám 8–12 strát). K IBSNinja jednu vec navyše, ktorá
