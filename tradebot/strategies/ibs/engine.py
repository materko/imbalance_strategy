...
from tradebot.core.clock import ClockState, SessionClock
from tradebot.core.drawing import DrawBox, DrawCommand, DrawKind
from tradebot.core.drawing import Palette as PAL
...
@dataclass
class IBSEngineOutput(EngineOutput):
    """Výstup IBS: k generickým orderom/kresbám/udalostiam pridáva stav seansy a novú zónu."""
...
class IBSEngine:
    ...
    def on_bar(
        ...
        *,
        ...
        out = IBSEngineOutput(clock=state)
