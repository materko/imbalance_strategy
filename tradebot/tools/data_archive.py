"""Rozdelí stiahnuté sviečky na ročné súbory a zase ich zloží späť.
    ...
    python -m tradebot.tools.data_archive split     # po stiahnutí dát
    python -m tradebot.tools.data_archive merge     # po klonovaní repozitára
    python -m tradebot.tools.data_archive status
