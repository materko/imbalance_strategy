"""Zoznam obchodov MultiCharts z logu študie (`%LOCALAPPDATA%/tradebot/multicharts.log`).
    ...
    python -m tradebot.tools.mc_log_trades                       # posledný beh v logu
    python -m tradebot.tools.mc_log_trades --from 2025-01-01 --to 2025-01-31
    python -m tradebot.tools.mc_log_trades --log C:/cesta/multicharts.log --json
